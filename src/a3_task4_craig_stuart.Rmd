...
The mean urchin size of the annual treatment is 3.92 cm and the mean of the control treatment is 3.73 cm. The difference between the means of the urchin sample treatments is very small, at only a 0.19 cm difference, suggesting that the means are fairly close together and making it difficult to determine how different the sample means are from one another. The 95% confidence intervals of -0.13 cm and 0.52 cm takes into consideration the spread of data to further explains the possible range of differences that the two means could be if samples means were taken again and again. The small sd of 0.97 cm and 0.87 cm of annual and control, respectively, suggests that the spread of data is small and there is less possible overlap of urchin sizes that would increase the possibility of drawing from populations with the same mean. The p-value helps us contextualize that possibility. A p-value of 0.25 is generally low and is saying that there is a low probability of the two sample means being at least this different if drawn from populations with the same mean. 
